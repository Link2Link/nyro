...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_provider_model_ratings,
            commands::list_provider_model_rating_profiles,
            commands::get_provider_model_rating_profile,
            commands::set_provider_model_rating_profile,
            commands::get_model_performance,
            commands::get_provider_model_rating,
            commands::set_provider_model_rating,
            commands::delete_provider_model_rating,
