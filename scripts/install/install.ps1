...
# Usage: irm https://raw.githubusercontent.com/Link2Link/nyro/master/scripts/install/install.ps1 | iex
#
...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "1.0.0"; irm https://raw.githubusercontent.com/Link2Link/nyro/master/scripts/install/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}

function Get-DownloadUrl {
    $script:DownloadUrl = "https://github.com/$Repo/releases/download/v$($script:ReleaseVersion)/Nyro_$($script:ReleaseVersion)_x64-setup.exe"
    $script:Filename = "Nyro_$($script:ReleaseVersion)_x64-setup.exe"
...
Write-ColorOutput "Cyan" "    $AppName AI Gateway Installer"
Write-ColorOutput "Cyan" "========================================"
Write-Host ""
